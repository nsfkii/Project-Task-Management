    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-5 rounded-2xl shadow-md border border-slate-100 dark:border-slate-700 flex items-center gap-4">
                <div className="p-3 bg-gradient-to-br from-indigo-500 to-red-600 text-white rounded-xl shadow-lg">
                    <CalendarIcon size={24} />
                </div>
                <div>
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Kalender Deadline</h2>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 overflow-hidden">
                            ...
                            return (
                                <div
                                    ...
                                    className={`min-h-[110px] p-2 rounded-xl transition-all duration-200 group ${
                                        isTodayFlag
                                            ? 'bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-500/20 dark:to-indigo-600/10 border-2 border-blue-400 dark:border-blue-500 shadow-md'
                                    ...
                                    <div className="flex justify-between items-start">
                                        <span
                                            className={`inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold transition-all ${
                                                isTodayFlag
                                                    ? 'bg-blue-600 text-white shadow-md shadow-indigo-500/30'
                                        ...
                                        {day.tasks.length > 0 && (
                                            <span className="text-xs font-bold text-white bg-blue-500 rounded-full px-1.5 py-0.5 shadow-sm">
                                                {day.tasks.length}
                                            </span>
                                        )}
                                    </div>
                ...
                <div className="p-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/30 flex justify-center">
                    <button
                        onClick={goToToday}
                        className="px-5 py-2 text-sm font-semibold rounded-xl bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 border border-indigo-200 dark:border-blue-800 shadow-sm hover:shadow-md hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-200"
                    >
                         Hari Ini
                    </button>
                </div>
