...
import { LayoutDashboard, Calendar, User, LogOut, Home, Building2, ChevronDown, ExternalLink, Settings, Menu, X } from 'lucide-react';
    ...
    return (
        <>
            ...
            >
                ...
                <nav className="flex-1 p-3 md:p-4 space-y-1 overflow-y-auto custom-scrollbar">
                    {navItems.map((item) => {
                    ...
                    <div>
                        <button
                            ...
                            className="flex items-center justify-between w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl text-slate-500 hover:bg-slate-50 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-700/50 dark:hover:text-slate-200 transition-all duration-300 font-medium text-sm md:text-base"
                        >
